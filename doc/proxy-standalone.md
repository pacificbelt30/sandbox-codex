...
Auth Proxy 単体利用には、主に次の 2 パターンがあります。
...
> 今後、この構成は Docker Compose でも設定可能にする予定です。
...
### `codex-dock run` で `codex-auth-proxy:18080` に到達できない
